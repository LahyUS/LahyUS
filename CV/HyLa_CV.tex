...
%---------%
  ...
  \tinysection{Summary}
  \textbf{I bridge the gap between Hardware and Intelligence.} As a Software Engineer specializing in \textbf{Embedded Systems} and \textbf{Applied AI}, I build systems that are both robust and smart. My expertise spans from low-level C/C++ and Linux optimizations to deploying Computer Vision and RAG solutions at the edge. I am committed to evidence-based engineering, focusing on precision, clarity, and documentable results.
