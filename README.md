...
As a Software Engineer specializing in **Software Development**, **Embedded Systems**, and **Applied AI**, I build systems that are both robust and smart. My expertise spans from low-level **C/C++** and **Linux** optimizations to deploying **Computer Vision** and **LLM/RAG** solutions on scalable web platforms. I focus on precision, clarity, and bringing intelligence to the edge.
